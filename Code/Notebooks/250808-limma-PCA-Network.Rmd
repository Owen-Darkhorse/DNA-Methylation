...
top200dmrsbyT <- rownames(testRes)[order(abs(testRes$t), decreasing = T)[1:200]]

top200dmrsbylimma <- top200dmrsbyB
```
...
## Compare Different Screening Results
...
venn.diagram(
  x = list(top200dmrsbyB, top200dmrsbyT, top200dmrs),
  category.names = c("B-stat Top 200" , "Moderated T Top 200" , "PCA Top 200"),
  filename = '../Images/screening_venn_diagramm.png',
  output=TRUE
)
